...
const (
	Device_Register_FullMethodName = "/device.Device/Register"
)
...
func (c *deviceClient) Register(ctx context.Context, in *RegisterReq, opts ...grpc.CallOption) (*RegisterResp, error) {
...
func (UnimplementedDeviceServer) Register(context.Context, *RegisterReq) (*RegisterResp, error) {
...
func _Device_Register_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DeviceServer).Register(ctx, req.(*RegisterReq))
	}
